 ...
 * Version:       2.7.1
 * Plugin URI:    http://www.transycan.net/blogtest/download-themes/
 * Description:   Change the number of posts displayed when viewing different archive pages. Original code by <a href="http://www.mattread.com">Matt Read</a>. Modified to work with WP 2.1.x
 * Author:        Moshu
 * Author URI:    http://www.transycan.net/
 *
 * License:       GNU General Public License
 *
 * 
 * Copyright (C) 2005  Matt Read & 2007 Moshu
 * 
...
class cqs
{
	...
	var $conditions = array('is_author', 'is_category', 'is_date', 'is_year', 'is_month', 'is_day', 'is_time', 'is_search', 'is_home', 'is_paged', 'is_feed');
	...
	function get_query() {
		...
		elseif  ($wp_query->is_author AND $this->options['is_author'])
	 ...
	 */
	function footer() {
		echo '<p style="text-align:center;margin-top:3em;">Custom Query String '. k_CQS_VER .' by <a href="http://mattread.com" style="font-family:cursive; font-size:1.1em;">Matt Read</a> and <a href="http://www.transycan.net" style="font-family:cursive; font-size:1.1em;">Moshu</a>.</p>';
	}
