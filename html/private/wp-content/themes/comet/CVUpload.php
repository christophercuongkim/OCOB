...
<?php get_header(); ?>
	...
	<div <?php post_class('post'); ?> id="post-<?php the_ID(); ?>">
		...
		<div class="post-text" style="padding-bottom: 200px">
			...
			<p><a href="<?php echo the_field('link_to_current_cv_page');?>">Go to current CV page &#8594;</a></p>
			<?php echo do_shortcode('[fileup base="2" sub="/'.get_field("folder_name").'" overwrite="true" filetypes=".pdf"]');?>
		</div>
	</div>
