...
function blacknwhite_add_admin() {
    ...
    add_theme_page($themename." Options", "".$themename." Options", 'edit_themes', basename(__FILE__), 'blacknwhite_admin');

}

function blacknwhite_admin() {
...
add_action('admin_menu', 'blacknwhite_add_admin'); ?>