...
<li><a href="http://www.academicprograms.calpoly.edu/specialinitiatives/accessexcellence/" target="_blank">Cal Poly Access to Excellence</a></li>
      ...
      <li><a href="#">Assessment of Learning</a>
        <ul>
          <li><a href="<?php bloginfo('url'); ?>?page_id=6">Assessment</a></li>
          <li><a href="http://www.cob.calpoly.edu/videos/">Assessment Videos</a></li>
          <li><a href="http://ocob-faculty.calpoly.edu/index.php/senior-projects/">Senior Projects</a></li>
          <li><a href="http://ocob-faculty.calpoly.edu/index.php/spring-2009-syllabi/">Current Syllabi</a></li>
      ...
      <li><a href="#">Faculty Development & Qualifications</a>
        <ul>
          ...
          <li><a href="http://ctl.calpoly.edu/index.html" target="_blank">Center for Teaching and Learning</a></li>
