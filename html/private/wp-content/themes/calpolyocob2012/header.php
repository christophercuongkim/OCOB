...
<script src="/private/wp-includes/js/jquery/jquery-migrate.js?ver=1.2.1"></script>
...
<div id="header">
    ...
    <hr />
    <div id = "myCalPolyNav">
    	<a href="https://my.calpoly.edu/" id="login" >my CalPoly login</a>
    </div> <!-- myCalPolyNav -->
    <div id = "utilityNav">
        <ul>
            ...
            <li id="maps"><a href="https://maps.calpoly.edu/">Maps</a></li>
        </ul>
    </div> <!-- utilityNav -->
    <div id="headerContent">
        <div id="cplogo" style="margin-top:20px;margin-bottom:20px;"> <a href="<?php echo 'https://www.calpoly.edu';?>" ><img src="https://webresource.its.calpoly.edu/cpwebtemplate/5.0.1/common/images_html/header/cp_logo_lrg.png" alt="Cal Poly, San Luis Obispo" id="thecplogo" title="" /></a> </div> <!-- cplogo -->
        <div id="deptName">
            <?php
...
function addSubMenus(lastLi, url) {
    jQuery.ajax({
    type: "POST",
    url: "/wp-content/themes/calpolyocob2012/custom_functions.php",
    dataType: 'json',
...
<div id="mobile-nav" class="visible-xs visible-sm row">
    <div style="width:200px; float:left;">
        <a href="https://www.calpoly.edu/"><img src="<?php echo get_template_directory_uri(); ?>/images/cp_logo_white.jpg" alt="Cal Poly" title="Go to Cal Poly Home"></a>
    </div>
...
if(has_nav_menu("mainmenulinks") ) {
	...
	<div id='cp'>
		<ul id='navbar' class='menu'>
			<li>
				<a href="https://www.ocob-faculty.calpoly.edu/welcome">
	...
	<ul id="cpUl" class="Mainmenu">
        <li>
        	<a href="https://newscully.cob.calpoly.edu/private/">
	        	<img height="24" width="20" src="<?php echo get_template_directory_uri(); ?>/images/home.png" alt="Orfalea College of Business" />
	        </a>
	    </li>
        <?php
...
// 			$cpto->undergraduate_blog_id,
			array('Graduate Programs', 'https://newscully.cob.calpoly.edu/private/gradbusiness/'),
			array('Alumni', 'https://newscully.cob.calpoly.edu/private/alumni-contact-info/'), //Added by PFed
			 );
            ...
            <div id="search">
                <form id="gs" method = "get" title = "Search Form" action="https://search.calstate.edu/search">
                    <div>
                        ...
                        <input type="hidden" name="proxystylesheet" value="slo-CalPoly" />
                        <input type="hidden" name="sitesearch" value="www.cob.calpoly.edu" />
                        <input type="text" id="q" name="q" placeholder="Search" title="Search this site" alt="Search Text" maxlength="175"/>
                        <input type="image" id="searchSubmit" name="submit" src="https://webresource.its.calpoly.edu/cpwebtemplate/5.0.0/common/images_html/header/search-arrow.png" alt="Go" title="Submit Search Query" />
                    </div>
                </form>
            </div>
...
if($pgtemp[count($pgtemp)-1] != 'homepage.php' && get_post_type() != "faculty_profile"){
	...
	<div id="breadcrumb"> <a href="https://www.cob.calpoly.edu" title="Orfalea College of Business" rel="nofollow" =""="">Home</a>&nbsp; : &nbsp;<a href="https://newscully.cob.calpoly.edu/private/directory" title="Directory" rel="nofollow" =""="">Directory</a></div>
