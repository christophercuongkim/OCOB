...
<div id="header">
  ...
  <!-- Removed Content to fix broken header --> 
  <div id = "audienceNav">
        <? /* wp_nav_menu(array( 'theme_location' => 'toplinks', 
										  'container' => false, 
										  'menu_class' => NULL,
  ...
  <hr />
  <div id = "myCalPolyNav"> <a href="http://my.calpoly.edu/" id="login" >my CalPoly login</a> </div>
  <div id = "utilityNav">
    <ul>
      ...
      <li id="quicklinks"><a href="javascript:;">Quick Links</a>
        <? wp_nav_menu(array( 'theme_location' => 'quicklinks', 
										  'container' => false, 
...
?>
  ...
  <div id="headerContent">
    <div id="cplogo"> <a href="<?php echo 'http://www.calpoly.edu';//get_bloginfo('url'); ?>" ><img src="http://webresource.its.calpoly.edu/cpwebtemplate/5.0.0/common/images_html/header/cp_logo.jpg" alt="Cal Poly, San Luis Obispo" height="75" width="150" title="" /></a> </div>
    <div id="deptName">
      <?php
...
?>
      ...
      <h3><a href="<?php echo 'http://www.cob.calpoly.edu';//get_bloginfo('url'); ?>"><?php echo get_bloginfo('description'); ?></a></h3>
    </div>
  </div>
</div>
<div id = "cp">
