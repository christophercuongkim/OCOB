      ...
      <form action="/scripts/form_skypevising.php" method="post" class="validate" style="width:650px; border:1px #CCC; padding:15px;">
        <fieldset>
          ...
          <table width="450" border="1" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td align="center">Monday 9-10 am</td>
              <td align="center">Mon, Wed, Thurs, Friday 9am-4pm</td>
            </tr>
            <tr>
              <td align="center">Tuesday 11am - noon</td>
              <td align="center">Tuesdays 10am-4pm.</td>
            </tr>
            <tr>
              <td align="center">Thursday 9-10 am</td>
              <td align="center">&nbsp;</td>
            </tr>
          </table>
