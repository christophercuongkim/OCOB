<?php// File: travel_grant-orig.php ?>

<?php get_header(); ?>
<?php get_sidebar(); ?>
<?php
/*
Template Name: Travel Grant
*/
session_start();
?>
			...
			<?php while (have_posts()) : the_post(); ?>		
				<div id="post-<?php the_ID(); ?>" <?php if(function_exists('post_class')) : post_class(); else : echo 'class="post"'; endif; ?>>
					...
					<h3 class="post-title">Orfalea Competitive Travel Grant APPLICATION<br />
					  <span style="color:red;">Due February 1st</span>
				</h3><script src="https://ajax.googleapis.com/ajax/libs/jquery/1.6.4/jquery.min.js" type="text/javascript"></script>
...
<div class="clear"></div>
					...
					<div style="width:650px; float:left; margin:5px;">
  <p>The Orfalea College of Business is looking to award grants to students who plan on studying during their academic career. Students will be evaluated on the following criteria:</p>
...
<p><strong>Date</strong>: <input name="date" type="text" style="background:#DDD;" value="<?php echo date("M jS, Y"); ?>" readonly="readonly" />
 &nbsp; &nbsp; &nbsp; <strong>Name</strong>:
     ...
     <strong>EMPLID</strong>:
		<input type="text"  name="emplid" maxlength="25" class="required" title="Your Cal Poly EMPLID is required." /></p>
     <p><strong>Currently enrolled Orfalea undergraduate?</strong>:
		...
		<input type="text"  name="cgpa" maxlength="6" class="required" style="width:3em;" title="Your Cal Poly cumulative GPA is required." /></p>
    ...
    <p><strong>Destination Country</strong>:
        ...
        <label><input name="english_speaking" type="radio" value="No" /> No</label></p>
    <p><strong>Name of Program & School/ Company</strong>:
		<input type="text"  name="pname" maxlength="50" class="required" title="The name of program & school/ company is required." /></p>
    ...
    <strong>Cell / Primary Phone </strong>:
      ...
      &nbsp; &nbsp; <strong>Home Phone (optional)</strong>:
		<input type="text"  name="hphone" maxlength="15"  style="width:6em;" class="" /></p>
        <br />
        <hr />
...
<label><input name="clevel" type="radio" value="After studying abroad I will have 4-6 quarters of study remaining at Cal Poly." class="required" title="Please indicate class level." /> After studying abroad I will have 4-6 quarters of study remaining at Cal Poly.</label><br />
        ...
        <textarea name="clevel_comment" style="width:500px;" rows="1"></textarea></p>
        
    <p><strong>Duration of formal study abroad trip</strong>:<br />
        <label><input name="duration" type="radio" value="I will spend at least 1 quarter (10 weeks) or more in a study abroad program." class="required" title="Please indicate duration of formal study abroad trip."  /> I will spend at least 1 quarter (10 weeks) or more in a study abroad program.</label><br />
		<label><input name="duration" type="radio" value="My study abroad is less than 10 weeks."/> My study abroad is less than 10 weeks.</label><br />
        Comments (Optional, 25 words or less):<br />
      <textarea name="duration_comment" style="width:500px;" rows="1"></textarea></p>
        
    <p><strong>Destination</strong>:<br />
        <label><input name="dest" type="radio" value="I will be studying abroad in Asia, South America, Africa or the Middle East." class="required" title="Please indicate destination."  /> I will be studying abroad in Asia, South America, Africa or the Middle East.</label><br />
		<label><input name="dest" type="radio" value="I will be studying abroad in Europe or Mexico."/> I will be studying abroad in Europe or Mexico.</label><br />
		<label><input name="dest" type="radio" value="I will be studying abroad in England, Canada, Australia, Scotland, Ireland, Wales or another English-speaking country."/> I will be studying abroad in England, Canada, Australia, Scotland, Ireland, Wales,<br /> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; or another English-speaking country.</label><br />
        Comments (Optional, 25 words or less):<br />
      <textarea name="dest_comment" style="width:500px;" rows="1"></textarea></p>
    ...
    <p><strong>Language Immersion<span style="color:red;">*</span></strong>:<br />
        ...
        Comments (Optional, 25 words or less):<br />
        <textarea name="immersion_comment" style="width:500px;" rows="1"></textarea></p>
...
<p>&nbsp;</p>
    <p><strong>Progress to Degree</strong>:<br />
		...
		<label><input name="progress" type="radio" value="No units will apply to my academic progress, except as 'free electives.'" /> No units will apply to my academic progress, except as "free electives."</label></p>
        ...
        <label><input name="prog_subs" type="radio" value="In Progress"/> In Progress</label></p>
        
        Comments (Optional, 25 words or less):<br />
      <textarea name="progress_comment" style="width:500px;" rows="1"></textarea></p>
	<p><strong>Statement of Purpose</strong>: Please provide a statement of purpose that outlines the reasons you have decided to study abroad. What goals will it help you achieve? In what ways will you share the benefits of this study abroad experience with other students when you return to campus? (100 words or less)
      <textarea name="purpose" style="width:600px;" rows="6" class="required" title="Please include a statement of purpose."></textarea></p>
	<p><strong>College Service</strong>: Please provide a short list of your service to the Orfalea College of Business. (25 words or less)
      <textarea name="services" style="width:600px;" rows="2" class="required" title="Please include a short list of your service to the Orfalea College of Business."></textarea></p>
      <hr />
<p>Upon submission you will receive a return email confirming your application has been received. <input style="float:right;" type="submit" name="Submit" value="Submit Form" /></p>
 </form>
			<?php endwhile; ?>
