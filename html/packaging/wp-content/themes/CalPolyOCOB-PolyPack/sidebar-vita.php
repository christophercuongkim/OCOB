...
<h2><a href="<?php echo "/vita"; ?>"><?php echo "CAL POLY VITA"; ?></a></h2>

<?php wp_nav_menu(array('menu' => 'VITA')); //Grabs the Menu from the Appearance > Menu option in Wordpress?> 
