...
<?php
    ...
    <div class="post">
    <a name="topH1"></a><h1><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a><a href="/handbook/"><button style="display:inline;float:right;margin-right:10px;">Back to Handbook Topics</button></a></h1>
