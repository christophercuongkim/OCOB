...
-->
    <?php
		...
		$quer .= 'posts_per_page=-1&category';
		$custom = get_post_custom();
		query_posts(array ( 'category_name' => 'litc-blog', 'posts_per_page' => -1 ));
		if(have_posts()) : ?>
    ...
    <?php
	  ...
	  if($year != $currentYear){
		  $currentYear = $year
		  ?>
		  <p></p><p></p><h1 class="year"><?php the_time("Y");?> Blogs</h1><?php
	  }
	  ...
	  ?>
    <div class="newsEntry">
      <a href="<?php the_permalink(); ?>" style="text-decoration: underline;font-size: large">
