...
function getProfile($mentorName) {
	...
	<form action="https://goo.gl/forms/NGA3qklE3n" target="_blank" method="GET">
	...
	foreach($categories as $category) {
		...
		echo "<img src='/wp-content/themes/CalPolyOCOB2012/images/EPIcons/".$photoName.".png' title='$theCategory' height='25px' width='25px'/> ";
	}
...
<h2 style="font-size:16px;">Find a Mentor</h2>
 <div style="float:left;width:25%;line-height:150%;display:block;">
  ...
  <div style="float:left;width:25%;line-height:150%;display:block;">
   ...
   <center>
   <form action="https://goo.gl/forms/iIQjt4aViwm1IFSL2" target="_blank" method="GET">
	<button class='mentorAvail' id='addMentor'>Request Mentor</button>
    </form>
