...
function addSubMenus(lastLi, url) {
    jQuery.ajax({
    type: "POST",
    url: "http://www.cob.calpoly.edu/wp-content/themes/calpolyocob2012/custom_functions.php",
    dataType: 'json',
...
<!--
    <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
              ...
              <li><a href="http://grad.calpoly.edu/students/continuous.html">Continuous Enrollment</a></li>
          </ul>
    </li>
-->
</ul><!-- #EndLibraryItem -->
...
if(has_nav_menu("mainmenulinks") ) {
	...
	<div id='cp'>
		<ul id='navbar' class='menu'>
			<li>
				<a href="http://www.cob.calpoly.edu/">
...
// 			$cpto->undergraduate_blog_id,
			array('Graduate Programs', 'http://www.cob.calpoly.edu/gradbusiness/'),
			array('Alumni', 'http://www.cob.calpoly.edu/alumni/'), //Added by PFed
			 );
