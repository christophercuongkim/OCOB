...
<?php include "/var/www/www.cob.calpoly.edu/html/_googleAnalytics.php"; ?>
</head>
...
<div id="header">
    ...
    <div id="headerContent">
        <div id="cplogo" style="margin-top:20px;margin-bottom:20px;"><img src="https://packaging.calpoly.edu/cpprc/wp-content/uploads/sites/3/2017/10/CPPRC-Logo-1.png" alt="Cal Poly, San Luis Obispo" id="thecplogo" style="width:63%; float:right"/></div> <!-- cplogo -->
        <div id="deptName">
            <?php
