<?php// File: directory_training_patrick.php ?>
<?php get_header();  ?>
...
<?php
/**
  *  Template Name: Directory Template Training Patrick
  *
  */
global $blog_id;
if ($blog_id == 27) {
						  ...
						  if( $my_query->have_posts() ) {
				            ...
				            <?php
								//foreach($category as $cat) {
									...
									$picture = get_field('exec_picture');
									...
									<tr>
										...
										<td style="vertical-align:top;">
											<p align="left" style="font-size:20px;">
												...
												<h2><strong><?php echo($execName); ?></strong></h2>
											</p>
										</td>
									</tr>
