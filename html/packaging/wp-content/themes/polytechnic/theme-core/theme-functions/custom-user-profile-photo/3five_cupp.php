...
function cupp_enqueue_scripts_styles() {
    // Register
    wp_register_style( 'cupp_admin_css', get_template_directory_uri() . '/theme-core/theme-functions/custom-user-profile-photo/css/styles.css', false, '1.0.0', 'all' );
    wp_register_script( 'cupp_admin_js', get_template_directory_uri() . '/theme-core/theme-functions/custom-user-profile-photo/js/scripts.js', array('jquery'), '1.0.0', true );
