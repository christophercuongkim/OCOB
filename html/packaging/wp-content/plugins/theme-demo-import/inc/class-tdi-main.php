...
class Theme_Demo_Import {
	...
	<div class="TDI__intro-notice notice notice-warning is-dismissible">
		<p><?php esc_html_e( 'Before you begin, make sure all the required plugins are activated.', 'theme-demo-import' ); ?></p>
	</div>

	<div class="tdi wrap about-wrap">

		<h1><?php esc_html_e( 'Theme Demo Import', 'theme-demo-import' ); ?></h1>
		...
		<div class="TDI__intro-text">
			...
			<p class="about-description">
				<?php esc_html_e( 'Quickly import your theme\'s live demo content, widgets and settings. This will provide you with a basic layout to build your website and speed up the development process.', 'theme-demo-import' ); ?>
			</p>

			<h3><?php esc_html_e( 'The following data will be imported:', 'theme-demo-import' ); ?></h3>

			<ul>
				<li><?php esc_html_e( 'Posts', 'theme-demo-import' ); ?></li>
				<li><?php esc_html_e( 'Pages', 'theme-demo-import' ); ?></li>
				<li><?php esc_html_e( 'Images', 'theme-demo-import' ); ?></li>
				<li><?php esc_html_e( 'Widgets', 'theme-demo-import' ); ?></li>
				<li><?php esc_html_e( 'Menus', 'theme-demo-import' ); ?></li>
				<li><?php esc_html_e( 'Settings', 'theme-demo-import' ); ?></li>
			</ul>

			<p><strong><?php esc_html_e( 'NOTE: Your existing content will NOT be deleted or modified.', 'theme-demo-import' ); ?></strong></p>
		...
		<p class="TDI__button-container">
			<button class="TDI__button  button  button-hero  button-primary  js-tdi-import-data"><?php esc_html_e( 'Import Demo Content', 'theme-demo-import' ); ?></button>
			<span><?php esc_html_e( 'Click the button once and wait. The import process may take several minutes.', 'theme-demo-import' ); ?></span>
		</p>
	...
	public function import_demo_data_ajax_callback() {
		...
		if ( empty( $this->frontend_error_messages ) ) {
			$response['message'] = sprintf(
				__( '%1$s%3$sThat\'s it, all done!%4$s%2$sThe demo import has finished. Please check your page and make sure that everything has imported correctly. If it did, you can deactivate the %3$sTheme Demo Import%4$s plugin.%5$s', 'theme-demo-import' ),
