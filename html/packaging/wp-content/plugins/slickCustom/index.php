...
function temp_func ($atts) {
    ...
    foreach ($custom['slides'] as $image) {
		...
		if($first == 0){
			$first = 1;
			$rs .= '<img src="' . $image['sizes']['large'] . '" class="attachment-post-thumbnail wp-post-image slick-slider-image" style="width : 730">';
		}else{
			$rs .= '<img data-lazy="' . $image['sizes']['large'] . '" class="attachment-post-thumbnail wp-post-image slick-slider-image" style="width : 730">';
		}
