...
$application['how_long'] = array('Do you plan on utilizing the conference rooms? If so, for what hours of the day, and how many days per week?',filter_var(trim($_POST['how_long']), FILTER_SANITIZE_STRING));
...
if($debug){
    ...
    $mail->addAddress('nelovgren@calpoly.edu', 'Cal Poly'); 
}
