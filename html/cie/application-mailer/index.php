...
$application['college'] = array('Are you a student at Cal Poly State University or Cuesta College? If you are a student, please list where and for how long?',$_POST['college']);
$application['individual'] = array('Are you working individually or as part of a team? If you are part of a team, will they be coworking too?',$_POST['individual']);
...
$application['start_date'] = array('Anticipated Start Date',filter_var(trim($_POST['start_date']), FILTER_SANITIZE_STRING));
...
$application['refname'] = array('Reference Name',filter_var(trim($_POST['refname']), FILTER_SANITIZE_STRING));
$application['refemail'] = array('Reference Email',filter_var(trim($_POST['refemail']), FILTER_SANITIZE_STRING));
...
if($debug){
    ...
    $mail->addAddress('alingerf@calpoly.edu', 'Cal Poly');
}
