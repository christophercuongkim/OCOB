<?php
    ...
    // Your code here to handle a successful verification
		...
		$to = array("rkontra@calpoly.edu");
		$subject = "Alumni Contact Info Form";
		$redirect = "http://www.cob.calpoly.edu/thank-you/";
		...
		sendForm($output,$subject,$to,$redirect);
         ...
         echo "<script>setTimeout(\"location.href = 'http://www.cob.calpoly.edu/alumni-contact-info/';\",1500);</script>";
         die();
	}
?>
