...
$output .= "<br><strong>This is my first appointment at the Advising Center:</strong> $first_appt<br>";
...
$output .= "$purpose<br>";
$output .= "<br><p><strong>Unit Count:</strong> The OCOB Advising Center does not do official unit counts. For an official unit count, you must see Evaluations in the Office of Academic Records (Bldg 1). We strive to assist students in tracking their total units, but the official unit count must be obtained from Evaluations.</p>
...
<p><strong>We Respect Your Privacy!</strong> Please know that the Advising Center maintains strict confidentiality. We will not disclose any academic or personal information except as permitted by the student or under situations where a student's safety would be in jeopardy. All OCOB Advisors are bound to confidentiality at all times.</p>";
$output .= "<span style=\"font-size:9px;\"><br>---------------------------<br>This intake form was automatically sent based on a response to the Advising Intake Form webpage. This form can be modified by a web administrator by editing the advising_intake.php template and the advising_intake.php script.</span>";

//echo $output;

$to = 'cobadvis@calpoly.edu';
$subject = "[Advising Intake] - $name, $email, $date_B";
...
//mail('jakechs@gmail.com', $subject, $output, $headers);
