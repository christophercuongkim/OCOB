<?php
    ...
    // Your code here to handle a successful verification
		$output = '';
		$output .= "<h2>A new Mustang Memories form has arrived!</h2><br>";
		$output .= "<p><strong>Memory about favorite professor:</strong> $memory </p></br>";
		...
		$to = array("pfederation@gmail.com", "rkontra@calpoly.edu");
		$subject = "Mustang Memories Form";
		$redirect = "/thank-you/";
		...
		sendForm($output,$subject,$to,$redirect);
         ...
         echo "<script>setTimeout(\"location.href = '/alumni-contact-info/';\",1500);</script>";
         die();
	}
?>
